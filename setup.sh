...
echo -e "✅ download \033[0;96m .zshrc\033[0m"
curl -o "/Users/jackfan/Library/Application Support/Sublime Text 3/Packages/User/Default (OSX).sublime-keymap" -L "https://raw.githubusercontent.com/jackfan108/env-setup/main/Default (OSX).sublime-keymap"
source ~/.zshrc